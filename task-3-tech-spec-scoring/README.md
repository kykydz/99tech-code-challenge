...
|                          | `actionToken`           | Type: String<br>Generated by the server when the action is initiated.<br>Token is:<br>• Single-use<br>• Short-lived (e.g., 30–60 seconds)<br>• Bound to `userId` and `actionId` |
